...
const stats = [
    ...
    { end: 4.8, decimals: 1, label: 'Google Rating', icon: '/icons/Mask group.png' },
    { end: 150, suffix: '+', label: 'Training Conducted', icon: '/icons/Mask group3.png' },
];
                        ...
                        {stats.map((stat, index) => (
                            <div key={index} className="relative mt-4 sm:mt-4">
                                ...
                                <div className="bg-[#F8EAFD] shadow-sm rounded-[10px] pt-[22px] sm:pt-[40px] pb-4 sm:pb-6 px-4 sm:px-7 h-full w-full">
                                    <div className="text-[22px] sm:text-[36px] md:text-[38px] font-bold text-gray-950 font-inter-tight leading-tight mb-0.5">
                                        <AnimatedNumber end={stat.end} decimals={stat.decimals} suffix={stat.suffix} />
                                    </div>
                                    <div className="text-[14px] sm:text-[26px] md:text-[28px] text-gray-700 font-medium">
                                        {stat.label}
                                    </div>
                                </div>
                            </div>
