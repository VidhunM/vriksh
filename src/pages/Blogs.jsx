...
const Blogs = () => {
    ...
    return (
        <section className="bg-white pt-0 min-h-screen pb-8">
            ...
            <div className="max-w-[1240px] mx-auto px-4 sm:px-6 py-6 sm:py-12">
                <h2 className="text-[#1A1A1A] text-[22px] sm:text-[32px] font-bold mb-6 sm:mb-8 font-inter-tight">
                    Featured Insight
                </h2>

                <div className="flex flex-col lg:flex-row gap-6 lg:gap-8 items-stretch">
                    {/* Left: Large Image Card */}
                    <div className="lg:w-1/2 relative group overflow-hidden rounded-[24px] sm:rounded-[32px] shadow-lg cursor-pointer">
                        <Link to="/blog/12">
                            <img
                                src="/images/mind body connection.jpg"
                                alt="When Your Mind Talks, Your Body Listens"
                                className="w-full h-[280px] sm:h-[400px] lg:h-full object-cover transition-transform duration-700 group-hover:scale-105"
                            />
                            <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/30 to-transparent flex flex-col justify-end p-6 sm:p-8">
                                <span className="text-white/80 text-[10px] sm:text-[12px] font-bold tracking-[0.2em] uppercase mb-2 sm:mb-3">Featured Post</span>
                                <h3 className="text-white text-[20px] sm:text-[32px] font-bold font-inter-tight leading-tight">
                    ...
                    <div className="lg:w-1/2 flex flex-col gap-5 sm:gap-6">
                        {/* Main Content Card */}
                        <div className="bg-[#FFF9E1] rounded-[24px] sm:rounded-[32px] p-6 sm:p-10 flex flex-col flex-grow shadow-sm hover:shadow-md transition-shadow">
                            <div className="flex justify-between items-start mb-4 sm:mb-6">
                                <p className="text-[#1A1A1A] text-[11px] sm:text-[12px] font-bold tracking-[0.1em] uppercase font-inter-tight">
                                    MARCH 20, 2026
                                </p>
                                <span className="bg-[#520378] text-white text-[9px] sm:text-[10px] px-2.5 py-1 rounded-full font-bold uppercase tracking-wider">
                                    Counselling
                                </span>
                            </div>
                            <h3 className="text-[#1A1A1A] text-[20px] sm:text-[28px] font-bold mb-3 sm:mb-4 font-inter-tight leading-[1.3]">
                            ...
                            <Link to="/blog/12" className="mt-auto flex items-center gap-2 group/btn">
                                <span className="text-[#1A1A1A] font-bold text-[15px] sm:text-[16px] group-hover/btn:underline font-inter-tight transition-all">
                                    Read Full Story
                                </span>
                                <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-[#520378] text-white flex items-center justify-center group-hover/btn:translate-x-1 transition-transform">
                                    →
                                </div>
                            </Link>
                        </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                            <Link to="/blog/7" className="bg-white border border-gray-100 rounded-[20px] sm:rounded-[24px] p-5 sm:p-6 shadow-sm hover:shadow-md transition-all group">
                            ...
                            <Link to="/blog/11" className="bg-white border border-gray-100 rounded-[20px] sm:rounded-[24px] p-5 sm:p-6 shadow-sm hover:shadow-md transition-all group">
            ...
            <div className="max-w-[1240px] mx-auto px-4 sm:px-6 py-6 sm:py-12">
                <div className="flex flex-col lg:flex-row justify-between items-start gap-6 sm:gap-8 mb-6 sm:mb-8">
                    <div className="max-w-[800px]">
                        <h2 className="text-[#1A1A1A] text-[28px] sm:text-[42px] font-bold font-inter-tight leading-[1.1] mb-5 sm:mb-6">
                ...
                <div className="relative group/slider overflow-hidden">
                    {/* Mobile Arrows */}
                    <div className="flex sm:hidden justify-between absolute top-[150px] -translate-y-1/2 w-full z-10 px-1 pointer-events-none">
                        <button
                            onClick={prevSlide}
                            className="w-9 h-9 rounded-full bg-white/95 shadow-lg flex items-center justify-center pointer-events-auto active:scale-95 transition-transform"
                        >
                            ...
                            {filteredPosts.map((post) => (
                                <div key={post.id} className="group cursor-pointer flex-none w-full sm:w-auto">
                                    <Link to={`/blog/${post.id}`}>
                                        ...
                                        <p className="text-gray-400 text-[12px] sm:text-[13px] font-medium mb-2 sm:mb-3">
                                            {post.date}
                                        </p>
                                    ...
                                    <Link to={`/blog/${post.id}`} className="inline-block bg-[#520378] text-white px-7 sm:px-8 py-2 sm:py-2.5 rounded-full text-[13px] sm:text-[14px] font-bold hover:bg-[#400260] transition-all">
                                        Read more
                                    </Link>
                                </div>
                            ))}
