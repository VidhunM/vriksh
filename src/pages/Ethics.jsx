        ...
        <section className="bg-white min-h-screen">
            ...
            <div className="max-w-[1000px] mx-auto px-6 py-12 sm:py-20 text-gray-800 text-[18px] leading-[1.8]">
                ...
                <div className="space-y-8 text-justify">
                    <div>
                        <p className="mb-4 font-medium">Vriksh Psychological Support Services is committed to upholding the highest ethical standards in the delivery of counselling and therapy services.</p>
                        <p>The following principles guide our practice:</p>
                    </div>

                    <div>
                        <h2 className="text-[26px] font-bold mb-6">1. Professional Conduct</h2>
                    ...
                    <div>
                        <h2 className="text-[26px] font-bold mb-6">2. Informed Consent</h2>
                    ...
                    <div>
                        <h2 className="text-[26px] font-bold mb-6">3. Confidentiality</h2>
                        ...
                        <p className="mt-4 italic">(Refer to our Privacy Policy for detailed information)</p>
                    </div>

                    <div>
                        <h2 className="text-[26px] font-bold mb-6">4. Client Welfare & Safety</h2>
                        <ul className="list-disc ml-6 space-y-2">
                    ...
                    <div>
                        <h2 className="text-[26px] font-bold mb-6">5. Cultural Sensitivity & Inclusivity</h2>
                    ...
                    <div>
                        <h2 className="text-[26px] font-bold mb-6">6. Professional Boundaries</h2>
                        <ul className="list-disc ml-6 space-y-2">
                    ...
                    <div>
                        <h2 className="text-[26px] font-bold mb-6">7. Complaints & Grievances</h2>
                        <ul className="list-disc ml-6 space-y-2 font-medium">
                            ...
                            <li>Users may contact us through the details provided on the website</li>
                        </ul>
                    </div>

                    <div>
                        <h2 className="text-[26px] font-bold mb-6">8. Compliance with Laws & Ethical Standards</h2>
                        <ul className="list-disc ml-6 space-y-2">
                    ...
                    <div>
                        <h2 className="text-[26px] font-bold mb-6">9. Continuous Improvement</h2>
