            ...
            <div className="relative max-w-[1440px] mx-auto px-6 py-6 sm:py-14 overflow-hidden">
                ...
                <div className="relative z-10 max-w-[1435px] mx-auto text-center">
                    ...
                    <div className="space-y-4 sm:space-y-8 text-gray-800 max-w-[1100px] mx-auto text-[15px] sm:text-[clamp(19px,1.4vw,22px)] leading-[1.6] sm:leading-[1.8] font-normal text-justify sm:text-center">
                        ...
                        <p className="">
                            Through counseling, institutional mental health programs, and high-impact training, we provide accessible and inclusive mental health support. Our goal is to create a nurturing environment where everyone feels heard, valued, and empowered to navigate life's challenges with resilience.
                        </p>
            ...
            <div className="max-w-[1240px] mx-auto px-6 pt-4 sm:pt-6 pb-8 sm:pb-10">
                <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-start lg:ml-[10%]">
                    ...
                    <div className="lg:pt-2">
                        <h2 className="text-[20px] sm:text-[clamp(36px,5vw,48px)] font-bold text-gray-950 leading-[1.2] mb-4 lg:mb-6 text-center lg:text-left font-inter-tight">
                ...
                <div className="mt-12 sm:mt-14 relative rounded-[20px] overflow-hidden h-[250px] sm:h-[320px] group">
                    ...
                    <div className="absolute inset-0 bg-black/30 flex flex-col items-center justify-center text-center px-6">
                        ...
                        <button onClick={() => document.getElementById('contact')?.scrollIntoView({ behavior: 'smooth' })} className="bg-[#520378] hover:bg-[#400260] text-white px-6 py-2.5 sm:px-6 sm:py-3 rounded-full font-bold text-[14px] sm:text-[20px] transition-all transform hover:scale-115">
                            Get Started
                        </button>
                    </div>
                </div>
