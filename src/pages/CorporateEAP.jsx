                        ...
                        {isMobile && (
                            <>
                                <button
                                    ...
                                    className={`absolute left-[-15px] top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-[#520378] border border-white/80 flex items-center justify-center transition-all z-20 shadow-xl ${currentSlide === 0 ? 'opacity-0 pointer-events-none' : 'hover:bg-[#400260] active:scale-90'}`}
                                >
                                ...
                                <button
                                    ...
                                    className={`absolute right-[-15px] top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-[#520378] border border-white/80 flex items-center justify-center transition-all z-20 shadow-xl ${(currentSlide + 1) * 3 >= offeringCards.length ? 'opacity-0 pointer-events-none' : 'hover:bg-[#400260] active:scale-90'}`}
                                >
                                    <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
