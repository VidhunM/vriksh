        ...
        <section className="bg-white min-h-screen">
            ...
            <div className="max-w-[1000px] mx-auto px-6 py-12 sm:py-20 text-gray-800 text-[16px] leading-[1.8]">
                <div className="space-y-8 text-justify">
                    <div>
                        <p className="font-semibold mb-4 text-[#520378] text-[18px]">Welcome to Vriksh Psychological Support Services (“we”, “our”, “us”).</p>
                        <p className="mb-4">By accessing or using our website <a href="https://vrikshenrichingminds.com/" className="text-[#520378] hover:underline font-medium">https://vrikshenrichingminds.com/</a>, you agree to comply with and be bound by the following Terms & Conditions. If you do not agree, please do not use our website or services.</p>
                    </div>

                    <div>
                        <h2 className="text-xl font-bold text-[#520378] mb-4">1. Use of Website</h2>
                    ...
                    <div>
                        <h2 className="text-xl font-bold text-[#520378] mb-4">2. Eligibility</h2>
                    ...
                    <div>
                        <h2 className="text-xl font-bold text-[#520378] mb-4">3. Nature of Services</h2>
                        <ul className="list-disc ml-6 space-y-2">
                    ...
                    <div>
                        <h2 className="text-xl font-bold text-[#520378] mb-4">4. Intellectual Property</h2>
                    ...
                    <div>
                        <h2 className="text-xl font-bold text-[#520378] mb-4">5. User Responsibilities</h2>
                    ...
                    <div>
                        <h2 className="text-xl font-bold text-[#520378] mb-4">6. Acceptable Use & Security</h2>
                        ...
                        <p className="mt-2 text-red-600 font-medium italic">Violations may result in civil or criminal liability, and we reserve the right to take appropriate legal action.</p>
                    </div>

                    <div>
                        <h2 className="text-xl font-bold text-[#520378] mb-4">7. Code of Conduct for Sessions</h2>
                        <p>Users agree to:</p>
                        <ul className="list-disc ml-6 mt-2 space-y-2">
                    ...
                    <div>
                        <h2 className="text-xl font-bold text-[#520378] mb-4">8. Disclaimer</h2>
                        <ul className="list-disc ml-6 space-y-2">
                    ...
                    <div className="bg-red-50 p-6 rounded-2xl border border-red-100">
                        <h2 className="text-xl font-bold text-red-600 mb-4 uppercase tracking-wide">9. Emergency Disclaimer</h2>
                        ...
                        <p className="mt-4 text-red-600 font-bold text-lg">Please contact: Emergency services | Nearest hospital | A suicide prevention helpline</p>
                    </div>

                    <div>
                        <h2 className="text-xl font-bold text-[#520378] mb-4">10. External Links</h2>
                        <p>Our website may include links to third-party websites. We are not responsible for their content, policies, or practices.</p>
                    </div>

                    <div>
                        <h2 className="text-xl font-bold text-[#520378] mb-4">11. Limitation of Liability</h2>
                    ...
                    <div>
                        <h2 className="text-xl font-bold text-[#520378] mb-4">12. Indemnity</h2>
                    ...
                    <div>
                        <h2 className="text-xl font-bold text-[#520378] mb-4">13. Legal Action</h2>
                        <p>Any attempt to defame the organization, spread false information or harm reputation may result in strict legal action.</p>
                    </div>

                    <div>
                        <h2 className="text-xl font-bold text-[#520378] mb-4">14. Governing Law & Jurisdiction</h2>
                    ...
                    <div>
                        <h2 className="text-xl font-bold text-[#520378] mb-4">15. Changes to Terms</h2>
