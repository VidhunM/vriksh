        ...
        <section className="bg-white min-h-screen">
            ...
            <div className="max-w-[1000px] mx-auto px-4 sm:px-6 py-12 sm:py-20 text-gray-800 text-[15px] sm:text-[18px] leading-[1.6] sm:leading-[1.8]">
                ...
                <div className="space-y-8 text-left sm:text-justify">
                    ...
                    <div>
                        <h2 className="text-xl sm:text-[26px] font-bold mb-4 sm:mb-6">1. Use of Website</h2>
                    ...
                    <div>
                        <h2 className="text-xl sm:text-[26px] font-bold mb-4 sm:mb-6">2. Eligibility</h2>
                    ...
                    <div>
                        <h2 className="text-xl sm:text-[26px] font-bold mb-4 sm:mb-6">3. Nature of Services</h2>
                        <ul className="list-disc ml-6 space-y-2">
                    ...
                    <div>
                        <h2 className="text-xl sm:text-[26px] font-bold mb-4 sm:mb-6">4. Intellectual Property</h2>
                    ...
                    <div>
                        <h2 className="text-xl sm:text-[26px] font-bold mb-4 sm:mb-6">5. User Responsibilities</h2>
                    ...
                    <div>
                        <h2 className="text-xl sm:text-[26px] font-bold mb-4 sm:mb-6">6. Acceptable Use & Security</h2>
                    ...
                    <div>
                        <h2 className="text-xl sm:text-[26px] font-bold mb-4 sm:mb-6">7. Code of Conduct for Sessions</h2>
                        <p>Users agree to:</p>
                        <ul className="list-disc ml-6 mt-2 space-y-2">
                    ...
                    <div>
                        <h2 className="text-xl sm:text-[26px] font-bold mb-4 sm:mb-6">8. Disclaimer</h2>
                        <ul className="list-disc ml-6 space-y-2">
                    ...
                    <div>
                        <h2 className="text-xl sm:text-[26px] font-bold mb-4 sm:mb-6">10. External Links</h2>
                        <p>Our website may include links to third-party websites. We are not responsible for their content, policies, or practices.</p>
                    </div>

                    <div>
                        <h2 className="text-xl sm:text-[26px] font-bold mb-4 sm:mb-6">11. Limitation of Liability</h2>
                    ...
                    <div>
                        <h2 className="text-xl sm:text-[26px] font-bold mb-4 sm:mb-6">12. Indemnity</h2>
                    ...
                    <div>
                        <h2 className="text-xl sm:text-[26px] font-bold mb-4 sm:mb-6">13. Legal Action</h2>
                        <p>Any attempt to defame the organization, spread false information or harm reputation may result in strict legal action.</p>
                    </div>

                    <div>
                        <h2 className="text-xl sm:text-[26px] font-bold mb-4 sm:mb-6">14. Governing Law & Jurisdiction</h2>
                    ...
                    <div>
                        <h2 className="text-xl sm:text-[26px] font-bold mb-4 sm:mb-6">15. Changes to Terms</h2>
                    ...
                    <div>
                        <h2 className="text-xl sm:text-[26px] font-bold mb-4 sm:mb-6">16. Acceptance of Terms</h2>
