                                ...
                                <div className="space-y-3">
                                    ...
                                    {event.whatsappLink && (
                                        <button
                                            ...
                                            className="w-full border-2 border-[#25D366] text-[#25D366] py-3.5 rounded-full font-bold text-lg hover:bg-[#25D366] hover:text-white transition-all active:scale-[0.98] flex items-center justify-center gap-2"
                                        >
