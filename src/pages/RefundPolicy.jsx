        ...
        <section className="bg-white min-h-screen">
            ...
            <div className="max-w-[1000px] mx-auto px-4 sm:px-6 py-12 sm:py-20 text-gray-800 text-[15px] sm:text-[18px] leading-[1.6] sm:leading-[1.8]">
                ...
                <div className="space-y-8 text-left sm:text-justify">
                    ...
                    <div>
                        <h2 className="text-xl sm:text-[26px] font-bold mb-4 sm:mb-6">1. Appointment Booking</h2>
                    ...
                    <div>
                        <h2 className="text-xl sm:text-[26px] font-bold mb-4 sm:mb-6">2. Payment Terms</h2>
                    ...
                    <div>
                        <h2 className="text-xl sm:text-[26px] font-bold mb-4 sm:mb-6">3. No-Show Policy</h2>
                        <ul className="list-disc ml-6 mt-2 space-y-2">
                    ...
                    <div>
                        <h2 className="text-xl sm:text-[26px] font-bold mb-4 sm:mb-6">4. Rescheduling Policy</h2>
                        <ul className="list-disc ml-6 mt-2 space-y-2">
                    ...
                    <div>
                        <h2 className="text-xl sm:text-[26px] font-bold mb-4 sm:mb-6">5. Cancellation & Refund Policy</h2>
                        <ul className="list-disc ml-6 mt-2 space-y-2">
                    ...
                    <div>
                        <h2 className="text-xl sm:text-[26px] font-bold mb-4 sm:mb-6">6. Courses, Webinars & Workshops</h2>
                        <ul className="list-disc ml-6 mt-2 space-y-2">
                    ...
                    <div>
                        <h2 className="text-xl sm:text-[26px] font-bold mb-4 sm:mb-6">7. Payment Liability Disclaimer</h2>
                    ...
                    <div>
                        <h2 className="text-xl sm:text-[26px] font-bold mb-4 sm:mb-6">8. Pricing Changes</h2>
                        <ul className="list-disc ml-6 mt-2 space-y-2">
                    ...
                    <div>
                        <h2 className="text-xl sm:text-[26px] font-bold mb-4 sm:mb-6">10. Policy Updates</h2>
                    ...
                    <div>
                        <h2 className="text-xl sm:text-[26px] font-bold mb-4 sm:mb-6">11. Acceptance</h2>
