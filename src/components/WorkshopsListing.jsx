...
const allWorkshopCards = [
    ...
    { title: 'Activities for dealing with adolescent challenges', subtitle: 'Empower adolescents with practical, activity-based coping strategies.', duration: '1.5 Hours', rating: '4.9', image: '/images/wrk2.png', categories: ['Counselling', 'Teachers', 'Special Education'] },
    ...
    { title: 'Career Counselling : Key Concepts & Approaches', subtitle: 'Explore essential concepts and approaches in career counselling', duration: '2 Hours', rating: '4.9', image: '/images/wrk2.png', categories: ['Counselling', 'Special Education', 'Corporate', 'Teachers', 'Students', 'Parents'] },
    { title: 'Essentials of Acceptance and Commitment Therapy', subtitle: 'Learn the fundamentals of Acceptance and Commitment Therapy', duration: '2 Hours', rating: '4.9', image: '/images/wrk2.png', categories: ['Counselling'] },
    ...
    { title: 'Activities used during counselling sessions', subtitle: 'Practical exercises to help clients reflect and grow', duration: '1.5 Hours', rating: '4.9', image: '/images/wrk2.png', categories: ['Counselling', 'Special Education'] },
    ...
    { title: 'Case History Taking Essentials', subtitle: 'Master essential skills for comprehensive case history taking', duration: '2 Hours', rating: '4.9', image: '/images/wrk2.png', categories: ['Counselling'] },
    ...
    { title: 'Understanding Body Image among Adolescents', subtitle: 'Practical strategies to guide adolescents toward a healthy self-view', duration: '2 Hours', rating: '4.9', image: '/images/wrk2.png', categories: ['Counselling', 'Special Education', 'Corporate', 'Teachers', 'Students', 'Parents'] },
    ...
    { title: 'Activity based strategies for children with special needs', subtitle: 'Learn techniques to make learning engaging and effective', duration: '2 Hours', rating: '4.9', image: '/images/wrk2.png', categories: ['Special Education', 'Teachers', 'Counselling'] },
    { title: 'Understanding Attention-Deficit/Hyperactivity Disorder', subtitle: 'Learn the fundamentals of ADHD - symptoms, challenges, and support strategies', duration: '2 Hours', rating: '4.9', image: '/images/wrk2.png', categories: ['Special Education', 'Teachers', 'Parents', 'Counselling'] },
    { title: 'Understanding Autism: Key Concepts', subtitle: 'Understand the spectrum - challenges, behaviors, and support methods', duration: '2 Hours', rating: '4.9', image: '/images/wrk2.png', categories: ['Special Education', 'Teachers', 'Parents', 'Counselling'] },
    ...
    { title: 'Behavior Modification', subtitle: 'Hands-on strategies for promoting desirable behaviors and reducing challenges', duration: '2 Hours', rating: '4.9', image: '/images/wrk2.png', categories: ['Special Education', 'Teachers', 'Parents', 'Counselling'] },
    ...
    { title: 'Understanding Learning Disabilities: Key Concepts', subtitle: 'Explore the fundamentals of LD - types, signs, and support strategies', duration: '2 Hours', rating: '4.9', image: '/images/wrk2.png', categories: ['Special Education', 'Teachers', 'Parents', 'Counselling'] },
    ...
    { title: 'Vineland Social Maturity Scale (VSMS) Assessment', subtitle: 'Learn to assess children’s social and adaptive skills', duration: '2 Hours', rating: '4.9', image: '/images/wrk2.png', categories: ['Special Education', 'Counselling'] },
    ...
    { title: 'ADHD Tool Kit - Practical Strategies and Activities', subtitle: 'Practical tools and activities to support children with ADHD', duration: '2 Hours', rating: '4.9', image: '/images/wrk2.png', categories: ['Special Education', 'Teachers', 'Counselling'] },
    { title: 'Assessment and Management of Autism', subtitle: 'Learn to assess and manage autism effectively in children', duration: '2 Hours', rating: '4.9', image: '/images/wrk2.png', categories: ['Special Education', 'Teachers', 'Counselling'] },
    ...
    // --- PARENTS ---
    { title: 'Understanding your teen child', subtitle: 'Support your teen’s emotional and social development with awareness and empathy.', duration: '2 Hours', rating: '4.9', image: '/images/wrk2.png', categories: ['Parents', 'Counselling', 'Special Education', 'Teachers'] },
    { title: 'Understanding Your Child’s Behaviour & Emotions', subtitle: 'Understand what drives your child’s behavior and how to respond effectively', duration: '2 Hours', rating: '4.9', image: '/images/wrk2.png', categories: ['Parents', 'Counselling', 'Special Education', 'Teachers'] },
    ...
    { title: 'Teacher–Student Relationship Building', subtitle: 'Practical tools for teachers to strengthen bonds and promote student success', duration: '2 Hours', rating: '4.9', image: '/images/wrk2.png', categories: ['Teachers', 'Counselling', 'Special Education'] },
    ...
    { title: 'Building Confidence & Self-Esteem', subtitle: 'Empower students to believe in themselves, overcome self-doubt, and reach their full potential.', duration: '2 Hours', rating: '4.9', image: '/images/wrk2.png', categories: ['Students', 'Counselling'] },
    ...
    { title: 'Career Guidance', subtitle: 'Equip students with tools to plan their future, set goals, and navigate career pathways', duration: '2 Hours', rating: '4.9', image: '/images/wrk2.png', categories: ['Students', 'Counselling'] },
    ...
    { title: 'Workplace Performance & Motivation', subtitle: 'Understand what drives employee commitment and apply techniques to strengthen retention', duration: '2 Hours', rating: '4.9', image: '/images/wrk2.png', categories: ['Corporate', 'Counselling'] },
    ...
    { title: 'Work - Life Balance', subtitle: 'Learn practical techniques to balance professional demands with personal wellbeing', duration: '2 Hours', rating: '4.9', image: '/images/wrk2.png', categories: ['Corporate', 'Counselling'] },
    ...
    { title: 'Team Building & Cohesion', subtitle: 'Practical strategies to enhance teamwork, synergy, and workplace harmony', duration: '2 Hours', rating: '4.9', image: '/images/wrk2.png', categories: ['Corporate', 'Counselling'] },
