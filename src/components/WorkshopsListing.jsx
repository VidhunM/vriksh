...
const allWorkshopCards = [
    ...
    { title: 'Neurodiversity in Classrooms', subtitle: 'Strategies to support diverse learning needs in the classroom.', duration: '2 Hours', rating: '4.9', image: '/images/wrk2.png', categories: ['Special Education', 'Teachers', 'Counselling'] },
    ...
    { title: 'Stress Management & Burnout Prevention', subtitle: 'Equip yourself with tools to handle stress and maintain balance at work or school', duration: '2 Hours', rating: '4.9', image: '/images/school 5.png', categories: ['Teachers', 'Counselling', 'Special Education'] },
    ...
    { title: 'Stress Management Skills for Students', subtitle: 'Empowering students to cope with stress, build resilience, and thrive in school and life.', duration: '2 Hours', rating: '4.9', image: '/images/school 7.png', categories: ['Students', 'Counselling'] },
    { title: 'Social Skills & Peer Relationships', subtitle: 'Practical strategies for students to improve communication, empathy, and relationship-building', duration: '2 Hours', rating: '4.9', image: '/images/school 8.png', categories: ['Students', 'Counselling'] },
