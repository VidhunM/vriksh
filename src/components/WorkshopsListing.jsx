...
const allWorkshopCards = [
    ...
    { title: 'Inclusive Classroom Strategies', subtitle: 'Learn practical strategies to create an inclusive classroom where every student can thrive', duration: '2 Hours', rating: '4.9', image: '/images/school 2.png', categories: ['Teachers', 'Counselling', 'Special Education'] },
