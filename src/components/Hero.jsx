                            ...
                            >
                                ...
                                {banner.description && (
                                    <p
                                        ...
                                        className={`text-[19px] md:text-[clamp(15px,2vw,18px)] mb-10 max-w-[650px] opacity-90 leading-relaxed font-normal text-justify sm:text-center mx-auto px-4 drop-shadow-md ${index === currentSlide ? 'animate-slide-up-fade opacity-0 delay-200' : ''
                                            }`}
                                    >
                                        {banner.description}
                                    </p>
