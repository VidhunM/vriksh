...
const trainingCards = [
    {
        ...
        subtitle: 'Practical counsellor’s guide to digital wellbeing', // Placeholder subtitle as original didn't have one
        rating: '4.9',
        duration: '1.5 Hours',
    ...
    {
        title: 'CBT for Children & Adolescents',
        subtitle: 'Practical counsellor’s guide to digital wellbeing',
        rating: '4.9',
        duration: '1.5 Hours',
        image: '/images/hwrkshp.png',
        categories: ['Counsellors']
...
const TrainingListing = () => {
    ...
    const filteredCards = trainingCards.filter(card =>
