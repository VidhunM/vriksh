    ...
    <div className="w-full h-full flex items-center justify-center">
        <div className="w-[90%] max-w-[950px] h-[450px] bg-white rounded-[24px] shadow-[0_20px_50px_rgba(0,0,0,0.15)] overflow-hidden flex flex-col md:flex-row border border-gray-100">
            ...
            <div className="md:w-[55%] p-8 md:p-12 flex flex-col justify-center text-left">
                <h3 className="text-[#1A1A1A] text-2xl md:text-3xl font-bold mb-4">{program.title}</h3>
                <p className="text-[#475467] text-base md:text-lg leading-relaxed mb-8">{program.desc}</p>
                <button className="w-fit bg-[#520378] text-white px-8 py-3 rounded-full font-bold hover:bg-[#3d025a] transition-colors">
                    Enquire Now
                </button>
            </div>
        </div>
