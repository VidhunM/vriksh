                    ...
                    <div className="lg:w-[55%]">
                        ...
                        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                            {categories.map((cat, index) => (
                                <div key={index} className="bg-[#FCA65B] p-5 rounded-2xl flex flex-col items-center justify-center text-center shadow-lg border border-black/5 hover:scale-[1.02] transition-transform h-full">
