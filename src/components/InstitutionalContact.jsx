            ...
            <div className="max-w-[1240px] mx-auto px-6 sm:px-12">
                <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 justify-between items-start -mt-10">
                    ...
                    <div className="w-full lg:w-[50%] flex flex-col pt-2">
                        <h3 className="text-[20px] sm:text-[28px] font-bold text-[#520378] mb-1 leading-snug">
                                ...
                                <>
                                    ...
                                    <div className="grid grid-cols-1 gap-4 relative" ref={dropdownRef}>
                                        <div
                                            ...
                                            className="w-full px-4 py-3 rounded-[8px] border border-gray-300 cursor-pointer flex justify-between items-center bg-white transition-all outline-none text-[15px] focus:border-[#520378] focus:ring-1 focus:ring-[#520378]"
                                        >
                                                ...
                                                <div className="max-h-[250px] overflow-y-auto py-2">
                                                    {eapOptions.map((option) => (
                                                        <div
                                                            ...
                                                            className="px-4 py-3 hover:bg-[#520378] hover:text-white transition-colors cursor-pointer text-[15px] text-gray-800 font-medium"
                                                        >
                                                            {option.label}
                                                        </div>
                                                    ))}
